...
<head>
    ...
    <link rel="stylesheet" href="{{ asset_url('vendor/css/rtl/theme-default.css') }}"
    ...
    <!-- Vendor -->
    <link rel="stylesheet" href="{{ asset_url('vendor/libs/@form-validation/umd/styles/index.min.css') }}" />

    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ asset_url('vendor/css/pages/page-auth.css') }}" />
        ...
        <div class="authentication-inner row">
            ...
            <div class="d-none d-lg-flex col-lg-7 p-0">
                <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
                    <img src="{{ asset_url('img/illustrations/auth-login-illustration-light.png') }}"
                        alt="auth-login-cover" class="img-fluid my-5 auth-illustration"
                        data-app-light-img="illustrations/auth-login-illustration-light.png')}}"
                        data-app-dark-img="illustrations/auth-login-illustration-dark.png')}}" />

                    <img src="{{ asset_url('img/illustrations/bg-shape-image-light.png') }}" alt="auth-login-cover"
            ...
            <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
              ...
              <button class="btn btn-primary d-grid w-100">Sign in</button>
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <a href="{{ route('googel.redirect') }}" class="btn btn-icon btn-label-google-plus me-3">
