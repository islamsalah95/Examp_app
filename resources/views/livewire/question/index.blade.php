        ...
        <div class="card-header flex-column flex-md-row" id="hide">
            <div class="dt-action-buttons text-end pt-3 pt-md-0">
                <div class="dt-buttons btn-group flex-wrap">
                    <div class="btn-group">
                        <button onclick="printDiv('questions')"
                    ...
                    <div class="btn-group">
                        <a href="{{ router('question.create') }}" class="btn btn-secondary create-new btn-primary"
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item"
                                            href="{{ route('question.edit', ['question' => $question['id']]) }}">
                                            <i class="ti ti-pencil"></i> Edit
                                        </a>

                                        <a class="dropdown-item"
                                        href="{{ route('question.editAnswers', ['question' => $question['id']]) }}">
                                        <i class="ti ti-pencil"></i> Edit Answers
                                    </a>
