        ...
        <div class="card-header flex-column flex-md-row" id="hide">
            <div class="dt-action-buttons text-end pt-3 pt-md-0">
                <div class="dt-buttons btn-group flex-wrap">
                    <div class="btn-group">
                        <button onclick="printDiv('chapters')"
                    ...
                    <div class="btn-group">
                        <a href="{{ router('chapter.create') }}" class="btn btn-secondary create-new btn-primary"
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <button class="dropdown-item text-danger" type="button"
                                            ...
                                            wire:confirm="{{ __('chapters/index.delete_confirm') }}">
